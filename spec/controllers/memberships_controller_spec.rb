...
describe MembershipsController do
  ...
  let(:valid_attributes) { { "paak_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved membership as @membership" do
        ...
        post :create, {:membership => { "paak_id" => "invalid value" }}, valid_session
        assigns(:membership).should be_a_new(Membership)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested membership" do
        ...
        Membership.any_instance.should_receive(:update).with({ "paak_id" => "1" })
        put :update, {:id => membership.to_param, :membership => { "paak_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the membership as @membership" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Membership.any_instance.stub(:save).and_return(false)
        put :update, {:id => membership.to_param, :membership => { "paak_id" => "invalid value" }}, valid_session
        assigns(:membership).should eq(membership)
      end
